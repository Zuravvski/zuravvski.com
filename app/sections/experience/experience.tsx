      ...
      <div className="md:border-l md:pl-6 md:border-zinc-700/40">
        <div className="flex flex-col space-y-16">
          ...
          >
            ...
            <p>
              As a competence leader in area of .NET I help backend programmers
              hone their skills by supporting them in their everyday work.
            </p>
            <p>
              As a leader of an internal knowledge sharing programme I organize
              monthly meetings, where passion-driven people can share their
          ...
          >
            <p>
              ...
              eius vel voluptas magni atque quae. Aperiam culpa quibusdam earum
              repellat?
            </p>
            <p>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Quam,
          ...
          >
            <p>
              ...
              recusandae minima officiis minus quibusdam? Suscipit quod cum
              maxime vitae!
            </p>
          </ExperienceItem>
          <ExperienceItem
          ...
          <ExperienceItem
            ...
            from="May 2017"
            to="June 2018"
            skills={["cplusplus", "react", "redux", "nodejs", "java", "spring"]}
